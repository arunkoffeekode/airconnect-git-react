...
import ChangeSeatModel from '../component/ChangeSeatModel'
...
function ChangeSeat() {
    return (
        <div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type='button' className='change-btn' data-toggle="modal" data-target="#exampleModalCenter">Change</button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
            ...
            <ChangeSeatModel></ChangeSeatModel>
        </div>
    )
}
